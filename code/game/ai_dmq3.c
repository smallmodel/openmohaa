...
qboolean EntityIsInvisible(aas_entityinfo_t *entinfo) {
	G_Printf("EntityIsInvisible: TODO!\n");
	return qfalse;
}
...
void BotAimAtEnemy(bot_state_t *bs) {
	...
	// su44: we need to reimplement it for MoH....
#if 0
...
#else
					0 // FIXME!!!!! isWeaponReadyToFire check needed!
#endif
...
void BotCheckAttack(bot_state_t *bs) {
	...
	//
	// su44: should we use the check below for melee attacks?
#if 0
...
void BotCheckForProxMines(bot_state_t *bs, entityState_t *state) {
	...
	trap_BotAddAvoidSpot(bs->ms, state->origin, 160, AVOID_ALWAYS);
	//
...
void Bot_ForceGoToEntity(bot_state_t *bs, int entnum) {
	bs->ainode = AINode_GoToEntity;
	bs->enemy = entnum;
}
/*
==================
