...
static void UI_NetworkOptionsMenu_Init( void ) {
	...
	networkOptionsInfo.menu.menuBack		= BG_WARREC;
	...
	networkOptionsInfo.graphics.generic.flags		= QMF_RIGHT_JUSTIFY|QMF_HIGHLIGHT_IF_FOCUS;
	...
	networkOptionsInfo.display.generic.flags		= QMF_RIGHT_JUSTIFY|QMF_HIGHLIGHT_IF_FOCUS;
	...
	networkOptionsInfo.sound.generic.flags			= QMF_RIGHT_JUSTIFY|QMF_HIGHLIGHT_IF_FOCUS;
	...
	networkOptionsInfo.back.generic.flags		= QMF_LEFT_JUSTIFY|QMF_HIGHLIGHT_IF_FOCUS;
	...
	networkOptionsInfo.back.style				= UI_LEFT;
