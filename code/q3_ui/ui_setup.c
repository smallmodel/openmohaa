...
static void Setup_ResetDefaults_Draw( void ) {
	UI_DrawProportionalString( SCREEN_WIDTH/2, 315 + PROP_HEIGHT * 0, "WARNING: This will reset *ALL*", UI_CENTER|UI_SMALLFONT, color_yellow );
	UI_DrawProportionalString( SCREEN_WIDTH/2, 315 + PROP_HEIGHT * 0.8f, "options to their default values.", UI_CENTER|UI_SMALLFONT, color_yellow );
}
...
static void UI_SetupMenu_Init( void ) {
	...
	setupMenuInfo.menu.showlogo		= qtrue;
	setupMenuInfo.menu.menuBack		= BG_OPTIONS;
	...
	setupMenuInfo.setupplayer.generic.flags			= QMF_CENTER_JUSTIFY|QMF_HIGHLIGHT_IF_FOCUS;
	...
	setupMenuInfo.setupcontrols.generic.flags		= QMF_CENTER_JUSTIFY|QMF_HIGHLIGHT_IF_FOCUS;
	...
	setupMenuInfo.setupsystem.generic.flags			= QMF_CENTER_JUSTIFY|QMF_HIGHLIGHT_IF_FOCUS;
	...
	setupMenuInfo.game.generic.flags				= QMF_CENTER_JUSTIFY|QMF_HIGHLIGHT_IF_FOCUS;
...
*/
	if( !trap_Cvar_VariableValue( "cl_paused" ) ) {
		...
		setupMenuInfo.defaults.generic.flags			= QMF_CENTER_JUSTIFY|QMF_HIGHLIGHT_IF_FOCUS;
	...
	setupMenuInfo.back.generic.flags				= QMF_LEFT_JUSTIFY|QMF_HIGHLIGHT_IF_FOCUS;
	...
	setupMenuInfo.back.style						= UI_LEFT;
