...
void InGame_Event( void *ptr, int notification ) {
	...
	case ID_RESTART:
		UI_ConfirmMenu( "Restart Battle?", 0, InGame_RestartAction );
		break;
...
void InGame_MenuInit( void ) {
	...
	s_ingame.team.generic.flags			= QMF_CENTER_JUSTIFY|QMF_HIGHLIGHT_IF_FOCUS;
	...
	s_ingame.addbots.generic.flags		= QMF_CENTER_JUSTIFY|QMF_HIGHLIGHT_IF_FOCUS;
	...
	s_ingame.removebots.generic.flags		= QMF_CENTER_JUSTIFY|QMF_HIGHLIGHT_IF_FOCUS;
	...
	s_ingame.teamorders.generic.flags		= QMF_CENTER_JUSTIFY|QMF_HIGHLIGHT_IF_FOCUS;
	...
	s_ingame.setup.generic.flags		= QMF_CENTER_JUSTIFY|QMF_HIGHLIGHT_IF_FOCUS;
	...
	s_ingame.server.generic.flags		= QMF_CENTER_JUSTIFY|QMF_HIGHLIGHT_IF_FOCUS;
	...
	s_ingame.restart.generic.flags		= QMF_CENTER_JUSTIFY|QMF_HIGHLIGHT_IF_FOCUS;
	...
	s_ingame.restart.string				= "Restart Battle";
	...
	s_ingame.resume.generic.flags			= QMF_CENTER_JUSTIFY|QMF_HIGHLIGHT_IF_FOCUS;
