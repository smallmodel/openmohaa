...
void Options_MenuInit( void ) {
	...
	s_options.graphics.generic.flags	= QMF_CENTER_JUSTIFY|QMF_HIGHLIGHT_IF_FOCUS;
	...
	s_options.display.generic.flags		= QMF_CENTER_JUSTIFY|QMF_HIGHLIGHT_IF_FOCUS;
	...
	s_options.sound.generic.flags		= QMF_CENTER_JUSTIFY|QMF_HIGHLIGHT_IF_FOCUS;
	...
	s_options.network.generic.flags		= QMF_CENTER_JUSTIFY|QMF_HIGHLIGHT_IF_FOCUS;
	...
	s_options.back.generic.flags    = QMF_LEFT_JUSTIFY|QMF_HIGHLIGHT_IF_FOCUS;
